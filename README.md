...
- **Sidebar**: collapsible and resizable, with a flat list of top-level folders, animated selection (a
  sliding accent indicator, bubble highlight on hover/select), and quick-create for folders/pages
